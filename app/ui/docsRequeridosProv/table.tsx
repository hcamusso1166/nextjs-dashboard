...
import {
    FormattedDocsRequeridosProvTable,
} from '@/app/lib/definitions';

export default async function DocsRequeridosProvTable({
    docsRequeridos,
}: {
    docsRequeridos: FormattedDocsRequeridosProvTable[];
}) {
  return (
    <div className="w-full">
      <h1 className={`${lusitana.className} mb-8 text-xl md:text-2xl`}>
        Documentos Requeridos a Proveedor
      </h1>
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between border-b py-5">
                      <div className="flex w-1/2 flex-col">
                        ...
                        <p className="font-medium">{docs.idParametro.idTipoDocumento.nombreDocumento}</p>
                      </div>
                      <div className="flex w-1/2 flex-col">
                        <p className="text-xs">CUIT</p>
                        <p className="font-medium">{docs.validezDias}</p>
                      </div>
                    </div>
